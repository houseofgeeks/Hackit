...
const About = () => {
  return (
    <div className="bg-[rgba(26,21,5,0.6)] md:px-24 sm:px-8 px-4 py-8 relative  w-[100%] min-h-[60vh]" id="about">
      ...
      <div className="flex  items-center justify-center flex-col text-slate-100">
        <div className="md:w-[700px]  w-[100%]">
          ...
          <span className="block my-2 text-lg">
            ...
            also experiencing the hackathon and give them an unforgettable
            experience.
          </span>
        </div>
      </div>
