...
const Partners = () => {
  ...
  return (
    <div className="bg-[rgba(26,21,5,0.6)] relative py-10 md:px-24 sm:px-8 px-4  w-[100%] min-h-[60vh]">
        ...
        {sponsorsData.map((sponsors) => {
          return (
            <div className="my-6 flex flex-col items-center">
              <h1 className="text-yellow-600 md:w-[450px] w-[100%] text-center bg-[rgba(255,255,255,0.1)] font-semibold font-[Urbanist] text-2xl px-6 py-2 rounded-md">{sponsors.type}</h1>
              <img className="md:max-w-[300px] max-w-[250px] mt-4" src={sponsors.img} alt="" />
            </div>
          );
        })}
      </div>
