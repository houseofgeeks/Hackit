      ...
      <div className="flex flex-col mt-4">
        ...
        <div>
          <input
            ...
            className="border outline-none text-black px-3 py-2 rounded-lg focus:border-red-500 my-2 w-[300px]"
          />
      ...
      <div className="flex flex-col mt-4">
        ...
        <div>
          <input
            ...
            className="border text-black outline-none px-3 py-2 rounded-lg focus:border-red-500 my-2 w-[300px]"
          />
          <button className="bg-red-500 ml-4 my-4 py-2 px-8 rounded-lg text-white font-semibold cursor-pointer text-lg hover:bg-red-600">
            Join
          </button>
